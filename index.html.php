...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* AMARAN NOTIFIKASI TEMPAHAN DEKAT SIAP */
        .alert-box {
...
<body>
    ...
    <div class="container">
        ...
        <div id="homePage" class="page-section active">
            ...
            <div class="grid-3">
                ...
                <div class="info-card">
                    <h3>🔔 Notifikasi Siap Tempahan</h3>
                    <p>Menerima notifikasi automatik untuk tempahan yang perlu disiapkan dalam masa terdekat.</p>
                </div>
            </div>
    ...
    <script>
        ...
        // MINTA KEBENARAN NOTIFIKASI SKRIN PELAYAR
        ...
        // KELUARKAN POP-UP NOTIFIKASI PELAYAR
        ...
        window.onload = function() {
            ...
            // Tarikh contoh disesuaikan dengan tarikh semasa
        ...
        // SEMAK DAN KIRA KIRA STATUS TARIKH
        ...
        // SEMAK APABILA LOG MASUK / BUKA HALAMAN TEMPAHAN
        function semakNotifikasiTempahan() {
            ...
            if (tempahanUrgent.length > 0) {
                ...
                // Hantar Notifikasi Pelayar Pop-up
