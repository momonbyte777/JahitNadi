    ...
    <div class="container">
        ...
        <div id="tempahanPage" class="page-section">
            <div class="dashboard-grid">
                ...
                <!-- BORANG MASUKKAN MAKLUMAT PELANGGAN -->
                <div class="card">
                ...
                <!-- JADUAL CARIAN & SENARAI REKOD PELANGGAN -->
                <div class="card">
    ...
    <script>
        ...
        window.onload = function() {
            ...
            if (storedData) {
                ...
                senaraiData = [
                    { id: Date.now(), nama: "Ahmad Razi", telefon: "0123456789", pakaian: "Baju Melayu Cekak Musang", ukuran: "Bahu: 17, Dada: 40. Nota: Nak poket berzip", tarikhSiap: "2026-09-01" },
                    { id: Date.now() + 1, nama: "Noraini Bemban", telefon: "0198765432", pakaian: "Baju Kurung Moden", ukuran: "Pinggang: 28, Labuh: 38. Nota: Kain susun tepi", tarikhSiap: "2026-10-15" }
                ];
                simpanKeStorage();
            }
            paparData();
        ...
        // PAPARAN GABUNGAN MAKLUMAT PELANGGAN + CATATAN DALAM SATU LAJUR
        function paparData() {
