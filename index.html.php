...
<body>
    ...
    <div class="container">
        ...
        <div id="homePage" class="page-section active">
            ...
            <!-- BORANG LOG MASUK (LOGIN) -->
            <div class="login-card">
                <h3>🔐 Log Masuk Pengguna</h3>
                <form id="loginForm" onsubmit="handleLogin(event)">
                    <div class="form-group">
                        <label for="username">Nama Pengguna / ID Usahawan:</label>
                        <input type="text" id="username" placeholder="Masukkan ID usahawan" required>
                    </div>
                    <div class="form-group">
    ...
    <script>
        ...
        function handleLogin(event) {
            ...
            alert(`Selamat Datang, ${user}! Log masuk berjaya.`);
