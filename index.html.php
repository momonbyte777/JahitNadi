...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* BAHAGIAN STATISTIK DIGITAL BERGERAK */
        .stats-section {
            background: #ffffff;
        ...
        /* REKA BENTUK INFO HOMEPAGE (JELAS BUKAN BUTANG) */
        .info-section-title {
            text-align: center;
            font-size: 1.4rem;
            color: var(--primary);
        ...
        .info-card-static {
            ...
            position: relative;
            cursor: default; /* Memastikan tetikus tidak menjadi ikon tangan */
            user-select: none;
        }
...
<body>
    ...
    <div class="container">
        ...
        <div id="homePage" class="page-section active">
            ...
            <div class="stats-section">
                <div class="stats-title">📊 Impak & Statistik Penggunaan Digital</div>
                <div class="stats-grid">
                    ...
                    <div class="stat-card">
                        <div class="stat-number" id="counterKepuasan">0%</div>
                        <div class="stat-label">Kadar Kepuasan Pengguna</div>
                    </div>
                </div>
            </div>
            ...
            <!-- KOTAK INFO STATIC (DIBAIKI SUPAYA TIDAK MENGELIRUKAN) -->
            ...
            <div class="grid-3">
                ...
                <div class="info-card-static">
                    <span class="info-badge">ℹ️ Fungsi Sistem</span>
                    <h3>🔔 Sistem Peringatan Automatikan</h3>
        ...
        <!-- HALAMAN 2: PENGURUSAN TEMPAHAN (SELEPAS LOG IN) -->
    ...
    <script>
        ...
        // FUNGSI ANIMASI COUNTER STATISTIK DIGITAL
        ...
        function mintaKebenaranNotifikasi() {
            if ("Notification" in window && Notification.permission !== "granted" && Notification.permission !== "denied") {
                Notification.requestPermission();
            }
        }

        function hantarNotifikasiPelayar(tajuk, mesej) {
            if ("Notification" in window && Notification.permission === "granted") {
                new Notification(tajuk, {
                    body: mesej,
        ...
        // PEMBAIKAN FUNGSI SIGN UP (DISIMPAN PERMANENT KE LOCALSTORAGE)
        ...
        function handleLogin(e) {
            ...
            // AKAUN DEFAULT DEMO (JIKA TIADA AKAUN)
            if (users.length === 0) {
            ...
            if (validUser) {
                ...
                alert('ID Penjahit atau kata laluan tidak sah! Sila pastikan anda telah mendaftar akaun.');
            }
        }
        ...
        window.onload = function() {
            ...
            // Jalankan animasi statistik digital bergerak
            animateCounter('counterUsahawan', 1250, '+');
            animateCounter('counterTempahan', 45800, '+');
            animateCounter('counterKepuasan', 99, '%');

            const hariIni = new Date();
            const tDuaHari = new Date(hariIni); tDuaHari.setDate(hariIni.getDate() + 2);
            const tTujuhHari = new Date(hariIni); tTujuhHari.setDate(hariIni.getDate() + 7);
            ...
            if (storedData) {
                ...
                senaraiData = [
                    { id: Date.now(), nama: "Ahmad Razi", telefon: "0123456789", pakaian: "Baju Melayu Cekak Musang", ukuran: "Bahu: 17, Dada: 40. Nota: Nak poket berzip", tarikhSiap: tDuaHari.toISOString().split('T')[0] },
                    { id: Date.now() + 1, nama: "Noraini Bemban", telefon: "0198765432", pakaian: "Baju Kurung Moden", ukuran: "Pinggang: 28, Labuh: 38. Nota: Kain susun tepi", tarikhSiap: tTujuhHari.toISOString().split('T')[0] }
                ];
                simpanKeStorage();
            }
            paparData();
        ...
        function semakNotifikasiTempahan() {
            ...
            if (tempahanUrgent.length > 0) {
                ...
                hantarNotifikasiPelayar(
                    "🚨 Peringatan Tempahan Urgent!",
                    `Anda mempunyai ${tempahanUrgent.length} tempahan yang hampir sampai tarikh siap.`
                );
            } else {
