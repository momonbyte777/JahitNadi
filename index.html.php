...
<body>
    ...
    <div class="container">
        ...
        <!-- HALAMAN PENGURUSAN TEMPAHAN (TERKUNCI KECUALI SELEPAS LOG IN) -->
    ...
    <script>
        ...
        function handleSignUp(e) {
            ...
            if (users.some(u => u.username === user)) {
                alert('Nama pengguna ini telah wujud. Sila pilih nama lain.');
                return;
            }
            ...
            alert('Pendaftaran akaun berjaya! Sila log masuk.');
