...
<body>
    ...
    <div class="container">
        ...
        <div id="homePage" class="page-section active">
            ...
            <div class="stats-section">
                <div class="stats-title">📊 Statistik Penggunaan Digital JahitNadi</div>
            ...
            <!-- KOTAK INFO STATIC (BUKAN BUTANG) -->
    ...
    <script>
        ...
        // ANIMASI BILANGAN BERGERAK SEHINGGA ANGKA SEBENAR
        ...
        function kemaskiniStatistikSebenar() {
            // 1. Kira jumlah usahawan yang berdaftar
            const users = JSON.parse(localStorage.getItem('jahitnadi_users')) || [];
            const jumlahUsahawan = users.length > 0 ? users.length : 1; // Minimum 1 (admin)

            // 2. Kira jumlah tempahan
            const tempahan = JSON.parse(localStorage.getItem('jahitnadi_tempahan')) || [];
            const jumlahTempahan = tempahan.length;

            // 3. Kira jumlah tempahan yang telah siap
            let jumlahSelesai = 0;
            ...
            // Jalankan animasi nombor mengikut data sebenar
            animateCounter('counterUsahawan', jumlahUsahawan);
            animateCounter('counterTempahan', jumlahTempahan);
            animateCounter('counterSelesai', jumlahSelesai);
        }
